...
mean_steps <- round(mean(total_steps_by_date$total_steps, na.rm = TRUE))
median_steps <- median(total_steps_by_date$total_steps, na.rm = TRUE)
```

The histogram below shows the distribution of steps made in a day.  The mean value, `r mean_steps`, and median value, `r median_steps`, are represented by the green line.
